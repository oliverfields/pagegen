...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${base_url}/assets/theme/css/site.css" type="text/css" />
    <script src="${base_url}/assets/theme/javascript/site.js"></script>
  </head>
  <body>
    <div id="page" class="clearfix">
      <i class="fas fa-bars" id="hamburger" onclick="toggle_sidebar();"></i>
      <div id="sidebar">
        <a id="page_logo" href="${base_url}"><img src="${base_url}/assets/theme/images/pagegen_150x28.png" alt="Pagegen" /></a>
      ...
      <article id="content">
        ${content}
        <div id="footer">Copyright &#169; ${year} &#8212; Generated by <a href="https://pagegen.phnd.net"><img src="${base_url}/assets/theme/images/pagegen_54x10.png" /></a></div>
      </article><!-- /content -->
    </div><!-- /page -->
    <script>
